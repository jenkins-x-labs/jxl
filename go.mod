...
require (
	...
	github.com/jenkins-x-labs/helmboot v0.0.72
	...
	github.com/jenkins-x/jx v0.0.0-20200330114332-b35f94d2f229
...
replace github.com/jenkins-x/jx => github.com/jenkins-x/jx v0.0.0-20200330114332-b35f94d2f229
