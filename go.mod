...
require (
	...
	github.com/jenkins-x-labs/helmboot v0.0.68
	...
	github.com/jenkins-x/jx v0.0.0-20200325100701-3d9af724c9cc
...
replace github.com/jenkins-x/jx => github.com/jenkins-x/jx v0.0.0-20200325100701-3d9af724c9cc
