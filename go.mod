...
require (
	...
	github.com/jenkins-x-labs/helmboot v0.0.69
	...
	github.com/jenkins-x/jx v0.0.0-20200327080754-b65af19b2758
...
replace github.com/jenkins-x/jx => github.com/jenkins-x/jx v0.0.0-20200327080754-b65af19b2758
