...
require (
	...
	github.com/jenkins-x-labs/helmboot v0.0.61
	...
	github.com/jenkins-x/jx v0.0.0-20200312171025-260777ac7056
...
replace github.com/jenkins-x/jx => github.com/jenkins-x/jx v0.0.0-20200312171025-260777ac7056
