...
require (
	...
	github.com/jenkins-x-labs/helmboot v0.0.58
	...
	github.com/jenkins-x/jx v0.0.0-20200310183134-df6d0b1d1c6f
...
replace github.com/jenkins-x/jx => github.com/jenkins-x/jx v0.0.0-20200310183134-df6d0b1d1c6f
