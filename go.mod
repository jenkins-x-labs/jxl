...
require (
	...
	github.com/jenkins-x-labs/helmboot v0.0.62
	...
	github.com/jenkins-x/jx v0.0.0-20200317204202-1424659e3266
...
replace github.com/jenkins-x/jx => github.com/jenkins-x/jx v0.0.0-20200317204202-1424659e3266
